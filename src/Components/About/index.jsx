    ...
    return (
      <Grid container justify="center" className="ui-about">
        <Grid item xs={11} sm={8} md={6}>
          ...
          <Grid container justify="space-around" className="about-products">
            <Grid item>
              <Button className="product-button" variant="outlined">Product-1</Button>
            </Grid>
            <Grid item>
              <Button className="product-button" variant="outlined">Product-2</Button>
            </Grid>
            <Grid item>
              <Button className="product-button" variant="outlined">Product-3</Button>
            </Grid>
          </Grid>
        </Grid>
      </Grid>
